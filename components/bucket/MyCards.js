...
class MyCards extends Component {
    ...
    render() {
        ...
        return <div className={'row justify-content-md-center justify-content-lg-center justify-content-sm-center content-pos'}>
                                ...
                                <div className={"row"}>
                                    ...
                                    <div className={"col-md-2 text-right"}>
                                        <a href={"javascript:void(0);"} style={{
                                            ...
                                            {bucket.ownerId === this.props.userId ?  <Icon size='large' name='trash alternate' onClick={() => this.props.openDeleteBucketModal(bucket._id)}/> : null}
